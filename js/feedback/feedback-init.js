  ...
  exhibits.forEach(exhibit => {
    ...
    if (!controlsContainer) {
      ...
      controlsContainer.className =
        'exhibit-controls absolute bottom-2 right-2 flex space-x-1';
    ...
    feedbackBtn.className =
      'feedback-btn p-1.5 rounded-full bg-slate-800/50 hover:bg-slate-700/50 transition-colors text-gray-300 hover:text-white';
