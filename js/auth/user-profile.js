...
class UserProfile {
    ...
    this.profileDropdownElement.innerHTML = `
      ...
      <div id="profile-dropdown-menu" class="absolute right-0 mt-2 w-56 rounded-md shadow-lg bg-slate-800 ring-1 ring-black ring-opacity-5 divide-y divide-slate-700 z-50 hidden">
        ...
        <div class="py-1">
          ...
          <button id="sign-out-btn" class="w-full text-left px-4 py-2 text-sm text-gray-300 hover:bg-slate-700">
  ...
  renderSignedOutState() {
    this.profileDropdownElement.innerHTML = `
      <button id="sign-in-btn" class="flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
    ...
    if (signInBtn) {
      signInBtn.addEventListener('click', this.handleSignInClick.bind(this));
    }
  }
