  ...
  if (!user) {
    ...
    favoritesContainer.innerHTML = `
      <div class="text-center py-8">
        <p class="text-gray-400 mb-4">Sign in to see your favorite projects</p>
        <button id="favorites-sign-in" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
    ...
    const signInBtn = document.getElementById('favorites-sign-in');
    if (signInBtn) {
...
function updateRecentlyViewedSection(user = authService.getCurrentUser()) {
  ...
  if (!user) {
    ...
    recentlyViewedContainer.innerHTML = `
      <div class="text-center py-8">
        <p class="text-gray-400 mb-4">Sign in to see your recently viewed projects</p>
        <button id="recent-sign-in" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
          <i class="fas fa-sign-in-alt mr-2"></i> Sign In
        </button>
      </div>
    `;
    ...
    // Add event listener to sign in button
    const signInBtn = document.getElementById('recent-sign-in');
    if (signInBtn) {
      signInBtn.addEventListener('click', () => {
        // Import auth modal dynamically
        import('./auth-modal.js').then(module => {
